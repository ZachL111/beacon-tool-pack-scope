"""Regression checks for the beacon-tool-pack-scope casebook."""
...
from casebook.harness import assert_expected, beacon_tool_pack_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(beacon_tool_pack_scope_summary(), assert_expected())
